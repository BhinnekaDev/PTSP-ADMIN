...
const ModalKonfirmasiHapusPengaduan = ({
  terbuka,
  tertutup,
  pengaduanYangTerpilih,
  konfirmasiHapusPengaduan,
  sedangMemuatHapus,
}) => {
  return (
    <Dialog
    ...
    >
      ...
      <DialogBody className="text-black">
        <p>
          ...
          <strong className="font-bold">{pengaduanYangTerpilih}</strong>?
      ...
      <DialogFooter className="space-x-4">
        <Button
          onClick={konfirmasiHapusPengaduan}
          variant="gradient"
          color="red"
...
export default ModalKonfirmasiHapusPengaduan;
